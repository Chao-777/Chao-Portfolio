...
export const About = () => {
  return (
    <section id="about" style={{ padding: '6rem 3rem 4rem' }}>
      ...
      <p style={{ color: 'var(--c-body)', fontSize: '0.95rem', lineHeight: 1.85, marginBottom: '2.5rem' }}>
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '0.5rem', marginBottom: '0.5rem' }}>
          <div>
            <div style={{ color: 'var(--c-heading)', fontSize: '0.95rem', fontWeight: 400 }}>
              Master of Information Technology — Software Development
            </div>
            <div style={{ color: 'var(--c-body)', fontSize: '0.875rem' }}>
              Griffith University
            </div>
          </div>
          <span className="term-tag" style={{ flexShrink: 0 }}>2023 — 2025</span>
        </div>
        <div style={{ color: 'var(--c-faint)', fontSize: '0.8rem', marginBottom: '0.75rem' }}>
